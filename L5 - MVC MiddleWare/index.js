...
import postsController from "./api/controllers/post.js";
import commentController from "./api/controllers/comment.js";
import rootRouterV1 from "./api/routes/index.js";
...
app.post("/app/v1/users", usersController.createNewUser);

// 2. Viết API cho phép user tạo bài post (thêm bài post, xử lý id tương tự user).
app.post("/app/v1/posts", postsController.createPost);
